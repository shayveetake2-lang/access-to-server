        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-y-auto">
            ...
            <div class="p-6 max-w-7xl w-full mx-auto space-y-6 flex-1 pb-28">
                <div class="flex items-end justify-between border-b border-slate-200 dark:border-slate-800/80 pb-4">
                    <div>
                        <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Server Debug Logs</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Inspect diagnostic output, database connection logs, and shell runtime checks.</p>
                    </div>
                </div>
