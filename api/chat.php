...
$systemPrompt .= "   - How to access: Open the 'Music Portal (Ampache)' page in the sidebar (music.html) and click the green 'Launch Ampache ↗' button, or visit https://serverflow.icu/ampache/public/login.php directly.\n";
...
$systemPrompt .= "- Live Websites & Deployer: Deploy sites directly from a GitHub URL. Automatically clones, builds, and publishes to /sites/{repoName}/. Delete or re-deploy with one click.\n";
